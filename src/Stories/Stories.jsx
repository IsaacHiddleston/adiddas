...
const Stories = () => {
  ...
  return (
    <div className="flex justify-between gap-10 px-[60px] py-7 bg-[#F5F5E5]">
      <Story
        header={"Stories, style, and sporting goods at adidas, since 1949"}
        passage={p1}
      ></Story>
      <Story header={"Workout clothes, for any sport"} passage={p2}></Story>
    </div>
  );
};
